// L4: validazione dell'host Ollama per evitare SSRF verso destinazioni interne
// (es. metadata cloud 169.254.169.254) nel caso in cui OLLAMA_HOST sia configurato
// da un ambiente non attendibile.
function resolveOllamaHost() {
  ...
  const blocked = ['169.254.169.254', 'metadata.google.internal', 'fd00::']
  if (blocked.includes(url.hostname)) return 'http://localhost:11434'
